...
<div class="container">
	 <br />
     	 <a class="btn btn-dark btn-lg" href="bookings/create">Add an operation</a></h3>
		 <br />
    	 <br />
        ...
        <tr><th>Number</th><th>Date</th><th>Type</th><th>Compte</th><th>Montant</th><th colspan="2">Actions</th></tr>
          ...
          <tbody>
           ...
           <a href="operations/delete?id=${operation.number}" class="btn btn-danger" onclick="if (!(confirm('Are you sure ?'))) return false">Delete</a>
           </td>
           </tr>
           </c:forEach>
           </tbody>
